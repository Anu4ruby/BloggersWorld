BloggersWorld::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'learning_ror_101.anu4ruby.c9.io' }
  ...
  user_name: "sadicarnot@gmail.com",
  password:  "123#pheonix"
  }
